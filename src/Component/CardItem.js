...
const CardItem = () => {
   ...
   return(
    <Grid container>
        <Grid item>
            <Card sx={{ border: 1, borderColor: 'divider', borderRadius: '15px', height:'360px', width:'293.5px', boxShadow: '0px 1px 3px rgba(16, 24, 40, 0.1), 0px 1px 2px rgba(16, 24, 40, 0.06)', marginTop:'50px'}}>
                <CardMedia
